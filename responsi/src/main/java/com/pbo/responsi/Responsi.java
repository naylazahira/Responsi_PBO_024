...
import com.pbo.responsi.service.Event1212;
...
public class Responsi {
    ...
    public static void main(String[] args) {
        CartRepository repository = new CartRepositoryMySQL();
        Event1212 discountStrategy = new Event1212();
        CartService service = new CartService(repository, discountStrategy);

        CartView view = new CartView();
        new CartController(service, view);
